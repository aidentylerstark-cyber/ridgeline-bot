...
client.once('ready', async () => {
  ...
  const rpEmbed = new EmbedBuilder()
    .setColor(0xFF69B4)
    .setTitle('🎭 Roleplay Identity')
    .setDescription(
      'Let the town know who you are. **🧒 Ridgeline Kids** will show as a **bright pink separate group** ' +
      'in the member sidebar so everyone can immediately tell you\'re roleplaying as a child.\n\n' +
      '⚠️ *Selecting Ridgeline Kids means your character is a minor. All interactions with your character ' +
  ...
  const communityEmbed = new EmbedBuilder()
    ...
    .setDescription(
      'Additional roles to customize your experience and unlock specialty channels.'
    );
  ...
  console.log('\nDone! #get-roles updated with Kids role.');
  client.destroy();
});
